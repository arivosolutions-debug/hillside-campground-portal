      ...
      >
        <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-2">
          ...
          <div className="px-6 py-3 rounded-xl">
            <label className="block text-xs font-bold uppercase tracking-wider text-hc-text-light mb-1">
              District
            </label>
            <select
              name="district"
        ...
        <button
          type="submit"
          className="bg-hc-primary text-white rounded-xl p-5 hover:bg-hc-primary-deep transition-colors shrink-0 active:scale-[0.97]"
          aria-label="Search"
        >
