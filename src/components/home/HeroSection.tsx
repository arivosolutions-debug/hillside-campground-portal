...
export const HeroSection: React.FC = () => {
  return (
    <header className="relative md:min-h-screen h-[55vh] md:h-auto flex items-end md:items-center overflow-hidden rounded-[24px] md:rounded-none mx-3 md:mx-0 mt-[72px] md:mt-0">
      {/* Background */}
