        ...
        <div className="space-y-4">
          <div className="flex items-start gap-4 p-5 bg-hc-bg-alt rounded-2xl">
            ...
            <div>
              ...
              <p className="text-sm text-hc-text font-body">{airportName}</p>
              {nearestAirportDistance && (
                <p className="text-xs text-hc-secondary font-body mt-1">{nearestAirportDistance}</p>
              )}
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 p-5 bg-hc-bg-alt rounded-2xl">
            ...
            <div>
              ...
              <p className="text-sm text-hc-text font-body">{railwayName}</p>
              {nearestRailwayDistance && (
                <p className="text-xs text-hc-secondary font-body mt-1">{nearestRailwayDistance}</p>
              )}
            </div>
          </div>
          ...
          {travelTips && (
            <div className="flex items-start gap-4 p-5 bg-hc-bg-alt rounded-2xl">
              <div className="w-11 h-11 bg-hc-bg rounded-full flex items-center justify-center shrink-0 shadow-card">
                <Car size={18} strokeWidth={1.5} className="text-hc-primary" />
              </div>
              <div>
                <p className="font-body font-semibold text-hc-primary text-sm mb-0.5">Travel Tips</p>
                <p className="text-sm text-hc-text font-body">{travelTips}</p>
              </div>
            </div>
          )}
